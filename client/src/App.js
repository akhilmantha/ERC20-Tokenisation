  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <p>You currently have: {this.state.userTokens} coffee tokens</p>
        <button type="button" onClick={this.handleBuyTokensButton}>Buy more tokens</button>
      </div>
    );
  }
}
